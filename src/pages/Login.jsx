...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : lt.invalidCredentials);
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="max-w-md w-full space-y-6 p-10 bg-white rounded-2xl shadow-2xl">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              >
                {isLoading ? lt.loggingIn : lt.loginButton}
              </button>
            </div>
          </form>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-white text-gray-400">{lt.or}</span>
            </div>
          </div>
