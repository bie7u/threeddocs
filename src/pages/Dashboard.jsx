        ...
        <div className="text-center">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-2">{t.dashboard.addNew}</h3>
              <p className="text-sm text-gray-600">{t.dashboard.addNewDesc}</p>
              <p className="text-xs text-gray-400 mt-1">
                Projekty: {projectsCount}/{MAX_PROJECTS}
                {projectsCount >= MAX_PROJECTS && <span className="text-red-500 ml-1">{t.dashboard.limitWarning}</span>}
              </p>
            </div>
