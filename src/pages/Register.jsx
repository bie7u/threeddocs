      ...
      <div className="max-w-md w-full space-y-6 p-10 bg-white rounded-2xl shadow-2xl">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-3 bg-white text-gray-400">{t('auth.orEmail')}</span>
          </div>
        </div>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-1">
              {t('forms.name')} <span className="text-gray-400 font-normal">({t('forms.optional')})</span>
            </label>
            <input
              id="name"
              name="name"
          ...
          <div className="space-y-3">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-sm text-gray-700">
                Akceptuję{' '}
                <Link to="/terms" target="_blank" rel="noopener noreferrer" className="font-medium text-blue-600 hover:text-blue-500">
                  {t('forms.acceptTerms')}
                </Link>{' '}
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-sm text-gray-700">
                Akceptuję{' '}
                <Link to="/privacy" target="_blank" rel="noopener noreferrer" className="font-medium text-blue-600 hover:text-blue-500">
          ...
          >
            {isLoading ? t('auth.registerLoading') : t('auth.registerBtn')}
          </button>
        </form>
